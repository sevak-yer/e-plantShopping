...
const cartItemsQuantity = useSelector(state => state.cart.items).reduce((accumulator, currentValue) => accumulator + currentValue.quantity, 0);

// sums.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <text x="130" y="135" font-family="Arial" font-size="90" fill="white" text-anchor="middle" dominant-baseline="middle">{cartItemsQuantity}</text></svg></h1></a></div>
            </div>
        </div>
        {!showCart? (
